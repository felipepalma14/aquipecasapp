...
import palma.felipe.aquipecas.fragments.LojasFragment;
import palma.felipe.aquipecas.fragments.MainFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.frag_layout,fragment,"Teste");

        fragmentTransaction.commit();


        //Ocean.newRequest().get().send();
        /*
        Criando minha referencia do Firebase
         */
